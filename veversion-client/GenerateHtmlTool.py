...
parser.add_argument("--unziptype", help="whether to cach date , if date have been downloaded in you local place you can set the value is n ", type=str)
...
htmlZipFile = "Kipawa-qnx-700-1.27r." + sysargv2  + '_dev-unstripped.zip' #------------------------set a params
...
def down_load_zip_from_network():
    urllist2 = "http://tar1.telenav.com:8080/repository/telenav/client/trunk/Kipawa/Kipawa-qnx-700-1.27r." + sysargv2 + "_dev-unstripped.zip"      
    absolutehtmlzipfilepath = os.getcwd() + "/" +sysargv1 +"/"+ htmlZipFile
    print(urllist2 )   
